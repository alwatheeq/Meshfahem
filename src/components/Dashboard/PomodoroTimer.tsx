  ...
  return (
    <>
      {mode === 'break' && isRunning && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/30 backdrop-blur-lg">
      ...
      <div className="fixed bottom-24 right-6 z-50">
        {expanded ? (
          <div
            className={`w-64 rounded-2xl shadow-lg border ${getThemeCardBg()} ${getThemeCardBorder()} p-4 space-y-3`}
          >
            ...
            <div className="text-center">
              <p className={`text-4xl font-mono font-bold ${getThemeTextPrimary()}`}>
